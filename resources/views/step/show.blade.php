<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{ route('step.edit', ['id' => $step->id ]) }}" class="float-right py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200">Edit</a>
    ...
    <div class="py-12 max-w-7xl mx-auto">
        <div class="bg-white shadow-sm sm:rounded-lg py-6 px-32">
            <livewire:step-detail-view :model="$step" />
        </div>
    </div>
</x-app-layout>
